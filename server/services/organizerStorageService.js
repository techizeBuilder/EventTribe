...
class OrganizerStorageService {
  ...
  async connect() {
    ...
    try {
      // Use MongoDB URI instead of DATABASE_URL which is for PostgreSQL
      const dbUrl = process.env.MONGODB_URI || "mongodb+srv://jeeturadicalloop:Mjvesqnj8gY3t0zP@cluster0.by2xy6x.mongodb.net/eventTribe";
